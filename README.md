...
The program reads data from citytemp.csv, converts temperatures from Celsius to Fahrenheit when required, groups records by city, and computes the average temperature for each city. The results are printed in a clean, formatted output.
